...
const Community: React.FC = () => {
  return (
    <div className="relative flex w-full flex-col items-center justify-center sm:px-[24px] md:px-[40px] lg:mb-[70px] lg:px-[80px] xl:mb-[100px]">
      <div className="relative z-10 flex max-w-[1157px] items-center justify-between rounded-md bg-gradient-to-r from-[#3E314F] via-[#3F3977] to-[#3F3977] p-[40px]">
        ...
        <a
          className="flex h-[69px] items-center justify-center rounded-sm bg-gradient-to-r from-[#9B51E0] to-[#3081ED] tracking-[-1px] text-white hover:opacity-70 sm:min-w-[240px] sm:px-4 sm:py-2 lg:min-w-[344px] lg:px-10 lg:py-4"
