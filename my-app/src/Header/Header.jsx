      ...
      <header className="header">
        ...
        <nav>
          <ul className="header__nav-list">
            <li className="header__nav-list-item">НАША МИССИЯ</li>
            <li className="header__nav-list-item">СООБЩЕСТВО</li>
            <li className="header__nav-list-item">ДОРОЖНАЯ КАРТА</li>
            <li className="header__nav-list-item">NFT</li>
            <li className="header__nav-list-item">FAQ</li>
          </ul>
        </nav>
        <button className="header__btn-language">RU</button>
        <button className="header__btn-add-wallet">Подключить кошелек</button>
      </header>
    </div>
  );
}
